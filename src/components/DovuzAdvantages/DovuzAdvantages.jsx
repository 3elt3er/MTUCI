    ...
    <>
      ...
      <div className={classes.flexBlock}>
        ...
        <div className={classes.columns}>
          ...
          <div className={classes.item}>
              <span>Фиксированная стоимость и удобный способ оплаты – стоимость за 1 предмет в месяц 7 900 руб. либо
                4 600 руб. (в зависимости от выбранного курса), оплата через QR-код в любом мобильном приложении российского банка</span>
          </div>
        </div>
      </div>
    </>
